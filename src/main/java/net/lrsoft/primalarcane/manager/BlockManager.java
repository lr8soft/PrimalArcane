...
public class BlockManager {
	...
	public static BlockUniform manaBench;
	...
	static {
		...
		manaBench = new BlockMachineTemplate(Material.IRON, "mana_bench", TileEntityManaBench.class, RenderGuiHandler.MANA_BENCH_ID);
		modBlockList.add(manaBench);
