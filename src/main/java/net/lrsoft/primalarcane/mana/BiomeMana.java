...
public class BiomeMana {
	...
	static {
		...
		addBiomeManaPNRate(Biomes.DEFAULT, 0.5f);
		addBiomeManaPNRate(Biomes.DESERT, 0.6f);
		addBiomeManaPNRate(Biomes.DESERT_HILLS, 0.65f);
		addBiomeManaPNRate(Biomes.EXTREME_HILLS, 0.75f);
		addBiomeManaPNRate(Biomes.EXTREME_HILLS_EDGE, 0.75f);
		addBiomeManaPNRate(Biomes.EXTREME_HILLS_WITH_TREES, 0.85f);
		addBiomeManaPNRate(Biomes.FOREST, 0.75f);
		addBiomeManaPNRate(Biomes.FOREST_HILLS, 0.8f);
		addBiomeManaPNRate(Biomes.FROZEN_OCEAN, 0.2f);
		addBiomeManaPNRate(Biomes.FROZEN_RIVER, 0.3f);
		addBiomeManaPNRate(Biomes.HELL, 1.0f);
		addBiomeManaPNRate(Biomes.ICE_MOUNTAINS, 0.2f);
		addBiomeManaPNRate(Biomes.ICE_PLAINS, 0.2f);
		addBiomeManaPNRate(Biomes.JUNGLE, 0.75f);
		addBiomeManaPNRate(Biomes.JUNGLE_EDGE, 0.75f);
		addBiomeManaPNRate(Biomes.JUNGLE_HILLS, 0.75f);
		addBiomeManaPNRate(Biomes.MESA, 0.75f);
		addBiomeManaPNRate(Biomes.MESA_CLEAR_ROCK, 0.75f);
		addBiomeManaPNRate(Biomes.MESA_ROCK, 0.75f);
		addBiomeManaPNRate(Biomes.MUTATED_BIRCH_FOREST, 0.75f);
		addBiomeManaPNRate(Biomes.MUTATED_BIRCH_FOREST_HILLS, 0.8f);
		addBiomeManaPNRate(Biomes.MUTATED_EXTREME_HILLS_WITH_TREES, 0.8f);
		addBiomeManaPNRate(Biomes.MUTATED_FOREST, 0.75f);
		addBiomeManaPNRate(Biomes.MUTATED_ICE_FLATS, 0.25f);
		addBiomeManaPNRate(Biomes.MUTATED_MESA, 0.75f);
		addBiomeManaPNRate(Biomes.MUTATED_MESA_CLEAR_ROCK, 0.75f);
		addBiomeManaPNRate(Biomes.MUTATED_MESA_ROCK, 0.75f);
		addBiomeManaPNRate(Biomes.OCEAN, 0.3f);
		addBiomeManaPNRate(Biomes.REDWOOD_TAIGA, 0.75f);
		addBiomeManaPNRate(Biomes.REDWOOD_TAIGA_HILLS, 0.75f);
